...
\newpage
\appendix
\section{Special commands in {\mdseries\texttt{jfp.cls}}}
...
\verb"jfp.cls" to typeset in the production typeface -- Monotype Times.
e.g.
%
\begin{verbatim}
  \documentclass[prodtf]{jfp}
\end{verbatim}
