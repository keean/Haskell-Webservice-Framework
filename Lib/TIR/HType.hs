...
instance HOccursMany HNil a where
    hOccursMany _ = []
instance {-# OVERLAPPING #-} HOccursMany r a => HOccursMany (HCons a r) a where
    hOccursMany (HCons a r) = a:hOccursMany r
instance {-# OVERLAPPABLE #-} HOccursMany r b => HOccursMany (HCons a r) b where
...
instance {-# OVERLAPPING #-} HOccursMany r a => HOccursMany1 (HCons a r) a where
    hOccursMany1 (HCons a r) = (a,hOccursMany r)
instance {-# OVERLAPPABLE #-} HOccursMany1 r a => HOccursMany1 (HCons a' r) a where
