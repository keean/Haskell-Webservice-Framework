...
type SqlColMap = Map String (Maybe String)
...
type SqlHandle a = forall m . (SqlIfIO m,SqlIO m,MonadState SqlState m,MonadPlus m) => m a
type DbHandle a = forall m . (SqlIO m,SqlIfIO m,MonadIO m,MonadPlus m) => m a
...
instance {-# OVERLAPPABLE #-} Monad m => SqlIfIO m where
   ioIfFail status fl = case toEnum (fromIntegral status) of
      s  | status < 0 -> fl s
         | otherwise -> return s

instance {-# OVERLAPPING #-} (Applicative (StateT SqlState m), SqlIfIO m) => SqlIfIO (StateT SqlState m) where
...
foreign import ccall unsafe "HIODBC_cbits.h sqlNewEnv"
  sqlNewEnv :: IO SqlEnv

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidEnv"
  sqlIsValidEnv :: SqlEnv -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteEnv"
  sqlDeleteEnv :: SqlEnv -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlAllocEnv"
  sqlAllocEnv :: SqlEnv -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlFreeEnv"
  sqlFreeEnv :: SqlEnv -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlNewConnect"
  sqlNewConnect :: IO SqlDbc

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidConnect"
  sqlIsValidConnect :: SqlDbc -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteConnect"
  sqlDeleteConnect :: SqlDbc -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlAllocConnect"
  sqlAllocConnect :: SqlEnv -> SqlDbc -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlFreeConnect"
  sqlFreeConnect :: SqlDbc -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlConnect"
  sqlConnect :: SqlDbc -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDisconnect"
  sqlDisconnect :: SqlDbc -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlNewStmt"
  sqlNewStmt :: IO SqlStmt

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidStmt"
  sqlIsValidStmt :: SqlStmt -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteStmt"
  sqlDeleteStmt :: SqlStmt -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlAllocStmt"
  sqlAllocStmt :: SqlDbc -> SqlStmt -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlFreeStmt"
  sqlFreeStmt :: SqlStmt -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlNewBuffer"
  sqlNewBuffer :: CLong -> IO (Ptr ())

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidBuffer"
  sqlIsValidBuffer :: Ptr () -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteBuffer"
  sqlDeleteBuffer :: Ptr () -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlSetStmtAttr"
  sqlSetStmtAttr :: SqlStmt -> CLong -> Ptr () -> CLong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlPrepare"
  sqlPrepare :: SqlStmt -> Ptr CChar -> CLong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlNumParams"
  sqlNumParams :: SqlStmt -> Ptr CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlCloseCursor"
  sqlCloseCursor :: SqlStmt -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlExecute"
  sqlExecute :: SqlStmt -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlNewUSmallInt"
  sqlNewUSmallInt :: IO (Ptr CUShort)

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidUSmallInt"
  sqlIsValidUSmallInt :: Ptr CUShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlGetUSmallInt"
  sqlGetUSmallInt :: Ptr CUShort -> IO CUShort

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteUSmallInt"
  sqlDeleteUSmallInt :: Ptr CUShort -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlNewSmallInt"
  sqlNewSmallInt :: IO (Ptr CShort)

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidSmallInt"
  sqlIsValidSmallInt :: Ptr CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteSmallInt"
  sqlDeleteSmallInt :: Ptr CShort -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlNumResultCols"
  sqlNumResultCols :: SqlStmt -> Ptr CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlGetSmallInt"
  sqlGetSmallInt :: Ptr CShort -> IO CShort

foreign import ccall unsafe "HIODBC_cbits.h sqlNewString"
  sqlNewString :: CShort -> IO (Ptr CChar)

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidString"
  sqlIsValidString :: Ptr CChar -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteString"
  sqlDeleteString :: Ptr CChar -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlNewUInteger"
  sqlNewUInteger :: IO (Ptr CULong)

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidUInteger"
  sqlIsValidUInteger :: Ptr CULong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteUInteger"
  sqlDeleteUInteger :: Ptr CULong -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlTables"
  sqlTables :: SqlStmt -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlColumns"
  sqlColumns :: SqlStmt -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> Ptr CChar -> CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDescribeCol"
  sqlDescribeCol :: SqlStmt -> CUShort -> Ptr CChar -> CShort -> Ptr CShort -> Ptr CULong -> Ptr CShort -> Ptr CShort -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlGetUInteger"
  sqlGetUInteger :: Ptr CULong -> IO CULong

foreign import ccall unsafe "HIODBC_cbits.h sqlFetch"
  sqlFetch :: SqlStmt -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlNewInteger"
  sqlNewInteger :: IO (Ptr CLong)

foreign import ccall unsafe "HIODBC_cbits.h sqlIsValidInteger"
  sqlIsValidInteger :: Ptr CLong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlDeleteInteger"
  sqlDeleteInteger :: Ptr CLong -> IO ()

foreign import ccall unsafe "HIODBC_cbits.h sqlGetData"
  sqlGetData :: SqlStmt -> CUShort -> CShort -> Ptr () -> CLong -> Ptr CLong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlGetInteger"
  sqlGetInteger :: Ptr CLong -> IO CLong

foreign import ccall unsafe "HIODBC_cbits.h sqlStmtError"
  sqlStmtError :: SqlEnv -> SqlDbc -> SqlStmt -> Ptr CChar -> Ptr CChar -> CLong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlConnectError"
  sqlConnectError :: SqlEnv -> SqlDbc -> Ptr CChar -> Ptr CChar -> CLong -> IO SqlReturn

foreign import ccall unsafe "HIODBC_cbits.h sqlEnvError"
